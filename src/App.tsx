...
function App() {
  ...
  const projects = [
    ...
    },
    {
      name: "redesign",
      imgUrl: k1Img,
      description: "Industrial company website redesign",
...

    {
      name: "Game Points",
      imgUrl: gameImg,
      description: "This is a free Game that will make your brain work.",
...

    {
      ...
      imgUrl: artImg,
      description:
        "The task was to create a corporate identity and design of an Internet Platform that would allow novice artists to earn money, and art lovers to purchase works for every taste and budget. To create new opportunities for interaction between talents and fans.",
    ...
    },
    {
      ...
      imgUrl: kompImg,
      description:
        "Designing materials for print such as brochures, business cards, posters, flyers, and packaging.",
  ...
  const experiences = [
    {
      name: "Компания №1",
      description:
        "Web designer — Implemented corporate website and mobile app. l cation designs. Prepared presentations, business cards, brochures. As a result of stuclying HTML and CSS, I created company website.",
      time: "2023 – Present",
    },
    {
      name: "NeoXonline",
